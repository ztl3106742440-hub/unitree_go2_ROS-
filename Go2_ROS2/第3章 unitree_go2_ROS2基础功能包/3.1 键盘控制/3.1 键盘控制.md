1.创建包
在 ~/unitree_go2_ws/src/base 下
输入`ros2 pkg create go2_teleop_ctrl_keyboard --build-type ament_python --dependencies rclpy unitree_api --node-name go2_teleop_ctrl_keyboard`

在go2_teleop_ctrl_keyboard.py中导入 ros2_node 模板
